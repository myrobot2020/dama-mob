...
import { Activity, BookOpen, Sparkles, Trees, User } from "lucide-react";
...
function HomeScreen() {
  ...
  const homeOptions = [
    {
      label: "Plant",
      detail: "Tickerplant ops",
      icon: Activity,
      onClick: () => navigate({ to: "/standalone", search: { view: "tape" } }),
    },
    {
      label: "AN Nikāya",
      detail: "Suttas",
