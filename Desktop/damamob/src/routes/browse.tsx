...
function BrowseScreen() {
  ...
  const virtualizer = useVirtualizer({
    ...
    estimateSize: () => 76, // Height of card + gap
    overscan: 5,
  });
  ...
  return (
    <div className="min-h-screen dama-screen">
      ...
      <div className="px-5">
        <div className="mt-2">
          <label htmlFor="browse-search" className="label-mono text-muted-foreground">
            Search
          </label>
          <input
            id="browse-search"
        ...
        <div className="mt-3 block">
          <label htmlFor="nikaya-filter" className="label-mono text-muted-foreground">
            Nikāya
          </label>
          <select
            id="nikaya-filter"
        ...
        <div className="mt-3 block">
          <label htmlFor="book-filter" className="label-mono text-muted-foreground">
            Book / division
          </label>
          <select
            id="book-filter"
                ...
                return (
                  ...
                  >
                    <Link
                      ...
                      className="glass rounded-2xl p-4 flex items-start justify-between gap-3 h-full"
                    >
