...
import { Route as DevPipeline2RouteImport } from './routes/dev.pipeline2'
...
import { Route as DevEvalsRouteImport } from './routes/dev.evals'
...
const DevPipeline2Route = DevPipeline2RouteImport.update({
  id: '/dev/pipeline2',
  path: '/dev/pipeline2',
  getParentRoute: () => rootRouteImport,
} as any)
...
const DevEvalsRoute = DevEvalsRouteImport.update({
  id: '/dev/evals',
  path: '/dev/evals',
  getParentRoute: () => rootRouteImport,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/dev/pipeline2': {
      id: '/dev/pipeline2'
      path: '/dev/pipeline2'
      fullPath: '/dev/pipeline2'
      preLoaderRoute: typeof DevPipeline2RouteImport
      parentRoute: typeof rootRouteImport
    }
    '/dev/pipeline': {
      id: '/dev/pipeline'
    ...
    '/dev/evals': {
      ...
      path: '/dev/evals'
      fullPath: '/dev/evals'
      preLoaderRoute: typeof DevEvalsRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/dev/chat': {
      id: '/dev/chat'
