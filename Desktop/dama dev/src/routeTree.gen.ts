...
import { Route as PlantNetworkRouteImport } from './routes/plant.network'
...
const PlantNetworkRoute = PlantNetworkRouteImport.update({
  id: '/network',
  path: '/network',
  getParentRoute: () => PlantRoute,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/plant/network': typeof PlantNetworkRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/plant/network': {
      id: '/plant/network'
      path: '/network'
      fullPath: '/plant/network'
      preLoaderRoute: typeof PlantNetworkRouteImport
      parentRoute: typeof PlantRoute
    }
    '/plant/hdb': {
      id: '/plant/hdb'
...
interface PlantRouteChildren {
  ...
  PlantNetworkRoute: typeof PlantNetworkRoute
...
const PlantRouteChildren: PlantRouteChildren = {
  ...
  PlantNetworkRoute: PlantNetworkRoute,
