...
Usage:
  python scripts/pipeline/01_download.py --manifest-only
  python scripts/pipeline/01_download.py
  python scripts/pipeline/01_download.py --mp3   # needs ffmpeg
  python scripts/pipeline/01_download.py --items 1-58
"""
