...
Example:
  python scripts/pipeline/07_segment_bounds.py "data/examples/sn/SN segmentation" data/raw/bounds/sutta_bounds_an_folders.csv --replace-prefix "data\\examples\\sn\\" --replace-prefix "data\\examples\\sn_heuristic_split\\"
"""
