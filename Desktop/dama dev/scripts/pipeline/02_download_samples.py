...
Usage:
  python scripts/pipeline/02_download_samples.py
  python scripts/pipeline/02_download_samples.py --limit 5
  python scripts/pipeline/02_download_samples.py --download-audio
